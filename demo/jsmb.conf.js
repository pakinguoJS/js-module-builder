jsmb.set({
    ...
    "transport": {
        files: [
            {
                expand: true,
                cwd: "/home/pakinguo/jsmb_demo/resource",
                src: "app/**/*.js",
                dest: "/home/pakinguo/jsmb_demo/resource"
            }
        ]
    },
    ...
    "version": {
        ...
        // 指定需要设置版本号的文件夹路径
        src: [
            "/home/pakinguo/jsmb_demo/resource/app/{lang}",
            "/home/pakinguo/jsmb_demo/resource/static",
            "/home/pakinguo/jsmb_demo/views/{lang}"
        ],
        options: {
            ...
            map: [
                [/\{\$BASE\}/, "/home/pakinguo/jsmb_demo/resource/"]
            ]
        }
    },
