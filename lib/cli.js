...
function rsync() {
    ...
    }, jsmb.util.path('_jsmb_/rsync.time'), null, null, null, jsmb.config.viewFlat);
    ...
    function travel(src) {
        ...
        ll.forEach(function (file) {
            ...
            if (fs.statSync(filepath).isDirectory()) {
                ...
                sync(filepath.replace(csrc, ''), jsmb.config.src, jsmb.util.path(jsmb.config.dest), jsmb.util.path(jsmb.config.view), jsmb.util.path('_jsmb_/rsync.time'), null, null, null, jsmb.config.viewFlat);
            }
        });
    }
